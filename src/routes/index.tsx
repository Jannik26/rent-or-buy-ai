  ...
  head: () => ({
    meta: [
      { title: "EstateAI – Mehr aus Immobilien-Leads machen" },
      {
        name: "description",
        content:
          "EstateAI beantwortet Immobilienanfragen automatisch, qualifiziert Käufer und Verkäufer und übergibt Termin-reife Leads an Ihr Maklerteam.",
      },
      { property: "og:title", content: "EstateAI – KI-Vertriebsassistent für Immobilien" },
      {
        property: "og:description",
        content: "Verwandeln Sie Immobilienanfragen in qualifizierte Termine.",
      },
    ],
  }),
  component: Landing,
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-20 pb-28 lg:pt-28 lg:pb-36 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-xl leading-relaxed">
              EstateAI beantwortet Interessenten automatisch, erkennt Kauf- und Verkaufsabsichten
              und unterstützt Immobilienunternehmen im Vertrieb.
            </p>
            ...
            <div className="mt-10 flex items-center gap-6 text-xs text-muted-foreground">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="size-3.5 text-gold" /> DSGVO-konform
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="size-3.5 text-gold" /> Käufer · Verkäufer · Bewertung
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="size-3.5 text-gold" /> 24/7 Erreichbarkeit
              </span>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-elegant ring-1 ring-border">
              <img
                src={hero}
                alt="Modernes Immobilien-Interieur"
              ...
              <div className="absolute inset-x-6 bottom-6 rounded-2xl bg-card/95 backdrop-blur p-5 ring-1 ring-border">
                <div className="flex items-start gap-3">
                  <div className="size-9 rounded-full bg-gradient-navy grid place-items-center text-gold font-display">
                    E
                  </div>
                  <div className="text-sm">
                    <div className="font-medium">Neuer qualifizierter Lead</div>
                    <div className="text-muted-foreground text-xs mt-0.5">
                      Max Müller · Verkäufer · Wohnung · Motivation: Verkleinerung · 3 Monate
                    </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 grid lg:grid-cols-2 gap-12">
        <div className="rounded-3xl border border-border bg-card p-10 shadow-soft">
          ...
          <h2 className="mt-3 font-display text-3xl">
            Zu viele Anfragen. Zu wenig qualifizierte Leads.
          </h2>
          <p className="mt-4 text-muted-foreground leading-relaxed">
            Immobilienunternehmen verlieren Zeit durch manuelle Bearbeitung von Anfragen, verpasste
            Erstkontakte und unqualifizierte Interessenten, die nie zu einem Termin führen.
          </p>
          <div className="mt-6 space-y-3 text-sm text-muted-foreground">
            {[
              "Anfragen aus mehreren Kanälen",
              "Lange Reaktionszeiten am Wochenende",
              "Kein einheitliches Qualifizierungsprofil",
            ].map((t) => (
              <div key={t} className="flex items-center gap-2">
                <Clock className="size-4 text-muted-foreground/60" /> {t}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-3xl bg-gradient-navy text-primary-foreground p-10 shadow-elegant relative overflow-hidden">
          ...
          <h2 className="mt-3 font-display text-3xl">
            Ein KI-Assistent, der wie ein erfahrener Makler qualifiziert.
          </h2>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6">
          {[
            {
              i: 1,
              t: "Interessent stellt eine Anfrage",
              d: "Der EstateAI-Chat begrüßt Besucher und fragt: kaufen, verkaufen oder bewerten lassen?",
            },
            {
              i: 2,
              t: "KI qualifiziert das Gespräch",
              d: "Immobilientyp, Standort, Motivation, Budget, Zeitraum – strukturiert in natürlicher Sprache.",
            },
            {
              i: 3,
              t: "Makler sieht eine Zusammenfassung",
              d: "Im Dashboard erscheinen Lead-Score, KI-Zusammenfassung und empfohlene nächste Aktion.",
            },
          ].map((s) => (
            <div key={s.i} className="rounded-2xl border border-border bg-card p-7 shadow-soft">
              <div className="size-10 rounded-xl bg-gradient-navy text-gold grid place-items-center font-display text-lg">
                {s.i}
              </div>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-6">
          {[
            {
              icon: Zap,
              t: "Sofortige Antworten",
              d: "Keine Wartezeiten. Interessenten erhalten 24/7 fundierte Antworten.",
            },
            {
              icon: Target,
              t: "3 Intent-Erkennung",
              d: "Kauf, Verkauf und Wertermittlung – jeweils mit dem passenden Qualifizierungsdialog.",
            },
            {
              icon: BarChart3,
              t: "Strukturierte Leads",
              d: "Score, Zusammenfassung und Handlungsempfehlung direkt im Dashboard.",
            },
            {
              icon: Building2,
              t: "Speziell für Immobilien",
              d: "Vortrainiert auf Käufer-, Verkäufer- und Bewertungsdialoge.",
            },
            {
              icon: ShieldCheck,
              t: "DSGVO & seriös",
              d: "Daten in der EU, klare Sprache, vollständige Transparenz.",
            },
            {
              icon: Sparkles,
              t: "Bereit für Claude & Gemini",
              d: "Austauschbare KI-Modelle – heute Gemini, morgen Claude. Ihre Wahl.",
            },
          ].map(({ icon: Icon, t, d }) => (
      ...
      <section id="demo" className="bg-primary text-primary-foreground py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <h2 className="mt-3 font-display text-4xl lg:text-5xl">
            Probieren Sie EstateAI jetzt aus
          </h2>
          <p className="mt-4 text-primary-foreground/70">
            Öffnen Sie unten rechts das Chat-Symbol und führen Sie ein Gespräch wie ein Interessent.
            Der qualifizierte Lead landet in Echtzeit im Makler-Dashboard.
          </p>
      ...
      <section id="kontakt" className="mx-auto max-w-5xl px-6 py-24">
        <div className="rounded-3xl bg-gradient-navy text-primary-foreground p-12 lg:p-16 text-center shadow-elegant relative overflow-hidden">
          ...
          <h2 className="font-display text-4xl lg:text-5xl relative">
            Mehr aus Immobilien-Leads machen.
          </h2>
          <p className="mt-4 text-primary-foreground/70 max-w-xl mx-auto relative">
            Lassen Sie uns zeigen, wie EstateAI in Ihrem Unternehmen täglich neue Beratungstermine
            erzeugt.
          </p>
